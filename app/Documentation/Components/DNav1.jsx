...
const DNav1 = () => {
  return (
    <div className='flex fixed w-full top-0 bg-white z-50 items-center border border-gray-100 font-themeFont not-italic justify-between px-8 text-sm py-3'>
