...
import OpenSource from "@/app/Components/Header/OpenSource";
import Learn from "@/app/Components/Header/Learn";
const DNav2 = () => {
  ...
  return (
    <div className="flex justify-between text-[14px] px-8 py-4 text-gray-600 items-center">
      <div className="flex gap-6 items-center">
        <Link href="/">{first}</Link>
        <div className="relative">
          <div id="hover" className="cursor-pointer">
            <div className="flex items-center gap-1 transition-all duration-300 hover:bg-themePurple/20 rounded-md px-3 py-2">
              <h1>Open Source</h1>
              <p className="text-lg">
        ...
        <div className="relative">
          <div id="hover2" className=" cursor-pointer">
            <div className="flex items-center gap-1 transition-all duration-300 hover:bg-themePurple/20 rounded-md px-3 py-2">
              <h1>Learn</h1>
              <p className="text-lg">
                <MdOutlineArrowDropDown />
      ...
      <div className="flex items-center gap-4 text-[13px]">
        <a
          className="py-[6px] text-themePurple font-medium rounded-md px-6 border border-themePurple transition-all duration-300 hover:bg-themePurple hover:text-white"
          href="#"
        >
          Contact
        </a>
        <a
          className="py-[6px] bg-themePurple text-white border-transparent font-medium rounded-md px-6 border transition-all duration-300 hover:bg-white hover:border-themePurple hover:text-themePurple"
          href="#"
        >
          Sign up
        </a>
